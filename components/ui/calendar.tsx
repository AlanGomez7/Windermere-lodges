...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: cn("relative p-0", userClassNames?.months),
        month: cn("space-y-4", userClassNames?.month),
        month_caption: cn("flex", userClassNames?.month_caption),
        caption_label: cn("text-lg font-medium mb-3", userClassNames?.caption_label),
        ...
        month_grid: cn("w-full border-collapse space-y-1", userClassNames?.month_grid),
        weekdays: cn("flex w-full justify-around bg-white py-2 rounded-md", userClassNames?.weekdays),
        weekday: cn("text-muted-foreground rounded-md w-9 font-semibold text-[0.9rem]", userClassNames?.weekday),
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal rounded-md aria-selected:opacity-100 disabled:line-through",
        ...
        today: cn("bg-accent text-accent-foreground", userClassNames?.today),
        outside: cn(
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
          userClassNames?.outside
        ),
        disabled: cn("text-gray-400 opacity-50 cursor-not-allowed", userClassNames?.disabled),
        range_middle: cn("aria-selected:bg-accent aria-selected:text-accent-foreground", userClassNames?.range_middle),
